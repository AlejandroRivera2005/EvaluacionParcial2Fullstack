...
public class ComidaController {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Comida> obtenerLibroPorId(@PathVariable Long id) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Comida> actualizarLibro(@PathVariable Long id, @RequestBody Comida detallesLibro) {
