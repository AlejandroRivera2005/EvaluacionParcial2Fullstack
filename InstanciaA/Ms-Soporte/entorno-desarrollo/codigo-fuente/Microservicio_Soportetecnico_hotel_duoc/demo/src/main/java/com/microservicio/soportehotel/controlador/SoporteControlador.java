...
@Tag(name = "Soporte", description = "gestión de soporte técnico")
@RestController
...
public class SoporteControlador {
    ...
    @Operation(summary = "Registrar nueva solicitud de soporte")
    ...
    @Operation(summary = "Listar todas las solicitudes de soporte",
               description = "Retorna la lista completa de solicitudes de soporte registradas en el sistema.")
    ...
    @Operation(summary = "Buscar solicitud de soporte por ID")
    @ApiResponses({
    ...
    @Operation(summary = "Actualizar solicitud de soporte existente")
    @ApiResponses({
    ...
    public ResponseEntity<SoporteDTOsalida> actualizarDTOsolicitud(@PathVariable long id, @Valid @RequestBody SoporteDTOentrada dto) {
     ...
     @Operation(summary = "Eliminar solicitud de soporte")
    @ApiResponses({
    ...
    public ResponseEntity<Void> eliminarSolicitud(@PathVariable @NonNull Long id) {
        ...
        if (eliminado) {
            ...
            throw new RuntimeException("No se encontró la solicitud con id " + id);
        }
    }
