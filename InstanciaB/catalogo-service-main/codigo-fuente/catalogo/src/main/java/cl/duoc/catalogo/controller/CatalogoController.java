...
public class CatalogoController {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Catalogo> obtenerLibroPorId(@PathVariable Long id) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Catalogo> actualizarLibro(@PathVariable Long id, @RequestBody Catalogo detallesLibro) {
