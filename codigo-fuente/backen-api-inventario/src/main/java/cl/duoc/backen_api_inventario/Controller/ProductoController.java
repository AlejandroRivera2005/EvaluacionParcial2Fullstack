...
@Tag(name = "Productos", description = "Operaciones relacionadas con productos en el inventario")
@RestController
...
public class ProductoController {
    ...
    @Operation(summary = "Listar productos", description = "Obtiene una lista de todos los productos en el inventario")     
    @ApiResponses(value = {
